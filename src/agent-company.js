...
class AgentCompanyService {
    ...
    buildWorkloadPrompt(config = {}, item = {}, weekKey = '') {
        ...
        return [
            ...
            '',
            'Operating rules:',
            '- Communicate directly with the user in your final response: lead with the outcome, include clickable Markdown links to the website, preview, or files, then concise verification and any unfinished work.',
            '- Never put the only usable website address or handoff inside an HTML artifact or scratch file. The final chat message is required even when you created files.',
            '- Create requested deliverables with the available tools. Do not generate a document merely to package a status update.',
