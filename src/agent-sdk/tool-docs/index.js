...
const TOOL_SUPPORT = {
  ...
  'game-studio': { status: 'stable', notes: ['Durable Lilly-owned browser game projects with versioned scenes/components, typed Blueprints, transactional commands, playtests, immutable builds, managed-app publishing, and rollback.', 'Requires GAME_STUDIO_ENABLED=true; disposable game prototypes remain on code-sandbox.'] },
