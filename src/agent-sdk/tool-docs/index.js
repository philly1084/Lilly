...
const TOOL_SUPPORT = {
  ...
  'game-studio': { status: 'stable', notes: ['Durable Lilly-owned browser game projects with agent-authored module manifests, typed systems, mechanics, prefab variants, materials, uploaded asset metadata, animation controllers, terrain heightfields, deterministic specifications, scenes/components, Blueprints, transactional commands, immutable builds, managed-app publishing, and rollback.', 'Requires GAME_STUDIO_ENABLED=true; disposable game prototypes remain on code-sandbox.'] },
