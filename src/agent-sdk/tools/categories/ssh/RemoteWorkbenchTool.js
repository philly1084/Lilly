  ...
  buildGitPreparePlan(params = {}) {
    ...
    return {
      ...
      command: [
        ...
        'fi',
        'mkdir -p .git/info',
        'grep -qxF ".kimibuilt/" .git/info/exclude 2>/dev/null || printf "%s\\n" ".kimibuilt/" >> .git/info/exclude',
        'grep -qxF "*.bak.*" .git/info/exclude 2>/dev/null || printf "%s\\n" "*.bak.*" >> .git/info/exclude',
