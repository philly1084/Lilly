...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html,body,#game-canvas{width:100%;height:100%;margin:0;overflow:hidden}body{overscroll-behavior:none}button{font:inherit}#game-canvas{display:block;background:#081018;touch-action:none}
    ...
    @media (pointer:coarse),(hover:none){.touch-controls{display:grid}.controls span{display:none}.controls{margin-left:165px}.controls button{min-width:64px;min-height:44px}}
    @media(max-width:600px){.hud{padding-top:var(--safe-top)}.hud-row{gap:8px}.panel{padding:9px 10px;border-radius:10px}.hud-row .panel{max-width:calc(100vw - 98px)}.score{font-size:22px}.objective{font-size:10px;max-width:100%}.level-name{max-width:52vw}.status{font-size:9px;padding:6px 8px}.controls{padding:6px;gap:5px}.controls button{padding:7px 9px}.touch-controls{width:132px;height:132px;grid-template-columns:repeat(3,40px);grid-template-rows:repeat(3,40px);gap:5px}.score-line{gap:10px}.health{font-size:9px}.health strong{font-size:14px}}
    @media(prefers-reduced-motion:reduce){.spinner{animation-duration:1.6s}.touch-controls button{transition:none}}
  </style>
</head>
<body>
  ...
  <div class="hud">
    <div class="hud-row">
      <div class="panel">
        ...
        <div class="score-line"><div class="score"><span id="score-value">0</span> / <span id="score-total">${pickupCount}</span></div><div class="health">Shield <strong id="health-value">3</strong></div></div>
