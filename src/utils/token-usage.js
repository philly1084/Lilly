...
function normalizeUsageMetadata(usage = {}) {
    ...
    const promptPaths = [
        ...
        'response.response_metadata.usage.prompt_tokens',
        'response.response_metadata.tokenUsage.promptTokens',
        'response.response_metadata.token_usage.prompt_tokens',
        'response.responseMetadata.usage.promptTokens',
        'response.responseMetadata.tokenUsage.promptTokens',
        'result.usage.prompt_tokens',
        'result.response_metadata.usage.prompt_tokens',
        'result.response_metadata.tokenUsage.promptTokens',
        'result.response_metadata.token_usage.prompt_tokens',
        'result.responseMetadata.usage.promptTokens',
        'result.responseMetadata.tokenUsage.promptTokens',
        'data.usage.prompt_tokens',
        'data.response_metadata.usage.prompt_tokens',
        'data.response_metadata.tokenUsage.promptTokens',
        'data.response_metadata.token_usage.prompt_tokens',
        'data.responseMetadata.usage.promptTokens',
        'data.responseMetadata.tokenUsage.promptTokens',
        'response_metadata.usage.prompt_tokens',
        'response_metadata.tokenUsage.promptTokens',
        'response_metadata.token_usage.prompt_tokens',
        'responseMetadata.usage.promptTokens',
        'responseMetadata.tokenUsage.promptTokens',
    ];
    const completionPaths = [
        ...
        'response.responseMetadata.usage.completionTokens',
        'response.responseMetadata.tokenUsage.completionTokens',
        'result.usage.completion_tokens',
        'result.response_metadata.usage.completion_tokens',
        'result.response_metadata.tokenUsage.completionTokens',
        'result.response_metadata.token_usage.completion_tokens',
        'result.responseMetadata.usage.completionTokens',
        'result.responseMetadata.tokenUsage.completionTokens',
        'data.usage.completion_tokens',
        'data.response_metadata.usage.completion_tokens',
        'data.response_metadata.tokenUsage.completionTokens',
        'data.response_metadata.token_usage.completion_tokens',
        'data.responseMetadata.usage.completionTokens',
        'data.responseMetadata.tokenUsage.completionTokens',
        'response_metadata.usage.completion_tokens',
        'response_metadata.tokenUsage.completionTokens',
        'response_metadata.token_usage.completion_tokens',
        'responseMetadata.usage.completionTokens',
        'responseMetadata.tokenUsage.completionTokens',
    ];
    const totalPaths = [
        'totalTokens',
        'total_tokens',
        ...
        'response.responseMetadata.usage.totalTokens',
        'response.responseMetadata.tokenUsage.totalTokens',
        ...
        'result.responseMetadata.usage.totalTokens',
        'result.responseMetadata.tokenUsage.totalTokens',
        'data.usage.total_tokens',
        'data.response_metadata.usage.total_tokens',
        'data.response_metadata.tokenUsage.totalTokens',
        'data.response_metadata.token_usage.total_tokens',
        'data.responseMetadata.usage.totalTokens',
        'data.responseMetadata.tokenUsage.totalTokens',
        'response_metadata.usage.total_tokens',
        'response_metadata.tokenUsage.totalTokens',
        'response_metadata.token_usage.total_tokens',
        'responseMetadata.usage.totalTokens',
        'responseMetadata.tokenUsage.totalTokens',
    ];
    const reasoningPaths = [
        ...
        'response_metadata.usage.reasoning_tokens',
        'response_metadata.tokenUsage.reasoningTokens',
        'responseMetadata.usage.reasoningTokens',
        'responseMetadata.tokenUsage.reasoningTokens',
    ];
    const cachedPaths = [
        'cachedTokens',
        'cached_tokens',
        ...
        'response_metadata.tokenUsage.cachedTokens',
        'responseMetadata.usage.cachedTokens',
        'responseMetadata.tokenUsage.cachedTokens',
    ];
    const cacheReadPaths = [
        ...
        'response_metadata.tokenUsage.cacheReadInputTokens',
        'responseMetadata.usage.cacheReadInputTokens',
        'responseMetadata.tokenUsage.cacheReadInputTokens',
    ];
    const cacheCreationPaths = [
        ...
        'response_metadata.tokenUsage.cacheCreationInputTokens',
        'responseMetadata.usage.cacheCreationInputTokens',
        'responseMetadata.tokenUsage.cacheCreationInputTokens',
    ];
    const modelCallPaths = [
        ...
        'response_metadata.usage.model_calls',
        'response_metadata.tokenUsage.modelCalls',
        'responseMetadata.usage.modelCalls',
        'responseMetadata.tokenUsage.modelCalls',
    ];
    const sourcePaths = [
        'source',
        'usage_source',
        ...
        'response.response_metadata.usage.source',
        'response.response_metadata.tokenUsage.source',
        'response.responseMetadata.usage.source',
        'response.responseMetadata.tokenUsage.source',
        'result.usage.source',
        'result.response_metadata.usage.source',
        'result.response_metadata.tokenUsage.source',
        'result.responseMetadata.usage.source',
        'result.responseMetadata.tokenUsage.source',
        'data.usage.source',
        'data.response_metadata.usage.source',
        'data.response_metadata.tokenUsage.source',
        'data.responseMetadata.usage.source',
        'data.responseMetadata.tokenUsage.source',
        'response_metadata.usage.source',
        'response_metadata.tokenUsage.source',
        'responseMetadata.usage.source',
        'responseMetadata.tokenUsage.source',
    ];
