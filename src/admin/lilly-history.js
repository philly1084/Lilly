...
const PHASES = [
  ...
  },
  {
    ...
    from: '2026-05-14',
    to: '2026-05-20',
    summary: 'PII vault routing, trusted workbook calculations, admin-preview hardening, self-reflection approvals, and safer note cleanup became a dedicated trust layer.',
  },
  {
    id: 'remote-agent-loop',
    label: 'Remote Agent Loop',
    from: '2026-05-21',
    to: '2026-05-31',
    summary: 'Remote CLI agent routing, Kokoro TTS scaling, direct proof markers, and web-chat progress handling turned remote work into a visible operating loop.',
  },
  {
    id: 'async-ops',
    label: 'Async Ops + Admin',
    from: '2026-06-01',
    to: '2026-06-06',
    summary: 'Codex-agent defaults, managed-app promotion, async runtime toggles, after-process audits, durable prompt refreshes, and admin capability maps moved into the backend spine.',
  },
  {
    id: 'artifact-docs',
    label: 'Artifact + Document Hardening',
    from: '2026-06-07',
    to: '2026-06-18',
    summary: 'Document recovery, real PPTX rendering, Notes image persistence, artifact downloads, skill routing, and conversation-plan repairs made generated outputs more dependable.',
  },
  {
    id: 'frontend-proof',
    label: 'Frontend Proof Rotation',
    from: '2026-06-19',
    to: '2026-06-25',
    summary: 'Admin, Web Chat, Web CLI, Canvas, and Notes received focused accessibility, metadata normalization, model-routing, and handoff polish backed by route-level checks.',
  },
  {
    id: 'agent-company',
    label: 'Agent Company + Review Loop',
    from: '2026-06-26',
    to: '2099-12-31',
    summary: 'Agent Company review paths, shared whiteboard recovery, CEO action context, artifact access, trace metadata, and action-history evidence became the active admin focus.',
  },
];
