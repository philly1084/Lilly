...
function buildPlannerPromptSurface() {
  return [
    ...
    'The default remote-cli-agent transport uses POST /api/codex-agent/run plus /events SSE; preserve returned threadId/sessionId for continuation, stream concise milestone output through the run/events channel, and treat remote_code_run/remote_code_status as MCP compatibility only.',
