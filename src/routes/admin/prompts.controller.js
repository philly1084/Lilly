...
function buildPlannerPromptSurface() {
  return [
    ...
    'The inner remote agent is the layer that calls remote_code_run and remote_code_status; the planner should not invent direct MCP calls unless it is already inside the remote-cli-agent runner.',
