...
function buildFrontendFormatGuide() {
    return [
        ...
        '- For complex, premium, or redesign requests, include a visible design-system choice: layout rhythm, token palette, typography hierarchy, interaction model, asset strategy, and a QA fallback decision instead of reusing a generic scaffold.',
...
function buildFrontendTechnologyGuide() {
    return [
        ...
        '- react-vite :: default for app workspaces, dashboards, interactive websites, multi-step flows, complex component state, forms, filters, tabs, editors, and reusable repo handoff.',
        ...
        '- Prefer local sandbox library routes under /api/sandbox-libraries/ for Three.js, GSAP, Matter.js, p5.js, D3, Chart.js, ECharts, Plotly, Cytoscape, force-graph, and 3D Force Graph, with CDN fallbacks only when needed.',
