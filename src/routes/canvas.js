...
const canvasSchema = {
    ...
    reasoningEffort: { required: false, type: 'string', enum: ['low', 'medium', 'high', 'xhigh', 'max', 'ultra'] },
    reasoning_effort: { required: false, type: 'string', enum: ['low', 'medium', 'high', 'xhigh', 'max', 'ultra'] },
...
function buildFrontendFormatGuide() {
    return [
        ...
        '- Route durable game-building requests to Lilly Game Studio and LillyProject/v1 contracts. Use Canvas frontend bundles and code-sandbox only for explicitly disposable prototypes, design explorations, and non-game workbenches.',
