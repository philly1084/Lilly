    ...
    return {
        ...
        remote: remoteRelevant
            ? [
                ...
                'The default remote-cli-agent transport uses `remote_code_run` and `remote_code_status` inside the runner; `POST /api/codex-agent/run` plus `/events` SSE is an explicit codex-agent opt-in.',
