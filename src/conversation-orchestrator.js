    ...
    return {
        ...
        remote: remoteRelevant
            ? [
                ...
                'The default remote-cli-agent transport uses the authenticated `/admin/remote-agent-tasks` provider lane for Codex, Kimi, and Grok; direct `/api/codex-agent` and `remote_code_run`/`remote_code_status` remain explicit compatibility lanes.',
