    ...
    return {
        ...
        remote: remoteRelevant
            ? [
                ...
                'The preferred remote-cli-agent transport uses `POST /api/codex-agent/run` plus `/events` SSE; legacy MCP compatibility uses `remote_code_run` and `remote_code_status` inside the runner only.',
