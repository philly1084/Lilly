const PODCAST_SCRIPT_DESIGNS = Object.freeze([
  ...
  },
  {
    ...
    summary: 'Calm instructor-led class with outcomes, core principles, demonstrations, common errors, practical checks, and a final recap.',
    guidance: 'Teach from source material like a structured technical class, not a regular podcast. Begin with the concrete capability the listener should gain, then teach prerequisites only when they unlock the next step. Move through the job in an order a good instructor would use: concept, demonstration, decision point, common error, correction, then a quick practical check. Keep signposts short and content-bearing. Do not keep saying "in this lesson", "in this course", "this module", or that the listener is learning; simply teach the material. Use clear sentence rhythm with short and medium sentences, not long padded clauses. Keep the voice calm, calculated, precise, and human; avoid hype, rambling banter, topical-show chatter, and lecture-note stiffness.',
  },
  {
    id: 'news-magazine',
    label: 'News Magazine',
