...
function ComponentBody({ component, onChange }: { component: LillyComponent; onChange(next: LillyComponent): void }) {
  ...
  if (component.type === 'Terrain') return <>
    ...
    <div className="property-hint">Walking follows the terrain surface. Terrain supports translation, scale and Y rotation; rigid-body heightfield physics is not enabled.</div>
  </>;
